...
public class VisitorFragment extends Fragment {
    ...
    protected int[][] buffer_visitorData = new int[BUFFER_SIZE][LENTH_OF_DATA];
    private FragmentVisitorBinding binding; // ViewBinding 객체
    protected int numOfSpaces = 5;  // 예시로 5개의 ToggleButton 생성
    protected String[] spaceName = new String[numOfSpaces];
